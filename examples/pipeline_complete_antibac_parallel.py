...
import featurex_pipeline_v3_pseaac_aac as FX #combine pseudoaac with actuall aac
...
vector_name = "pipeline_complete_antibac_v3_pseaac_aac"
model_name = "pipeline_complete_antibac_v3_pseaac_aac"
numcores = 4
...
pos_input_name = "antibacterial_pos_complete_100_apd_reduced.txt"
neg_input_name = "uniprot_3_100_noannotationantibacterial_reduced.txt"
...
def main(model=None):
    ...
    if use_random_small_sequence_negative!=0:
        neg_dvec = IO.deserialize_descriptor_vector("neg_random_small_sequence") #same as neg_cytotoxic
