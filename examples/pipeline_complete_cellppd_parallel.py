...
vector_name = "pipeline_complete_cellppd_v3_pseaac_aac"
model_name = "pipeline_complete_cellppd_v3_pseaac_aac"
numcores = 4
...
pos_input_name = "cellppd_pos_complete_reduced.txt"
neg_input_name = "uniprot_3_34_neg_cellppd_reduced.txt"
...
def do_kfolds(x, y):
    ...
    for train, test in kfold.split(x, y):
        ...
        print("Training model on data...")
        s_training = time.time()
        M = trainer.build_sequential_model(rate = 0.5, shape = x_train.shape[1])
        trained_M = trainer.fit_model_batch(M, x_train, y_train, num_epoch=2000)
