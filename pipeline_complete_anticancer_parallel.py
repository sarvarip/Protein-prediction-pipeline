...
vector_name = "pipeline_complete_anticancer_v3_pseaac_acc"
model_name = "pipeline_complete_anticancer_v3_pseaac_acc"
numcores = 4
...
pos_input_name = "cancer_pos_complete_uniprot_reduced.txt"
neg_input_name = "uniprot_3_50_noannotationanticancer_reduced.txt"

'''Only If choice 2/4/5 is chosen'''

already_extracted_test = 1
